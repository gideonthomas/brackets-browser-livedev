...
(function (global) {
    ...
    var postMessageTransport = {
        ...
        connect: function (url) {
            console.log("postMessageTransport connect");
            var self = this;
        ...
        enable: function () {
            this.connect();
            console.log("enable _Brackets_LiveDev_Transport");
            var self = this;
            ...
            window.addEventListener("message", function (event) {
                ...
                if (event.data.method === "CSS.setStylesheetText") {
                    parent.postMessage(JSON.stringify({
                        type: "message",
                        message: event.data.method
                    }), "*");
                }
            });
        }
